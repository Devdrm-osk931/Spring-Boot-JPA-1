...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Assert.assertEquals("주문한 상품 쫑류 수가 정확해야한다", 1, getOrder.getOrderItems().size());
    ...
    @Test
     public void 주문취소() throws Exception {
        ...
        Assert.assertEquals("주문이 취소된 상품은 재고가 원상복구 돼야한다", 10, item.getStockQuantity());
    }
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "학동로", "123456"));
        em.persist(member);
        return member;
    }
